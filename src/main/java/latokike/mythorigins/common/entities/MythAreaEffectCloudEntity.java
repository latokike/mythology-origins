...
public class MythAreaEffectCloudEntity extends Entity {
    ...
    public MythAreaEffectCloudEntity(EntityType<? extends MythAreaEffectCloudEntity> entityType, World world) {
    ...
    public MythAreaEffectCloudEntity(World world, double x, double y, double z) {
        this(MOEntities.MYTH_AREA_EFFECT_CLOUD, world);
